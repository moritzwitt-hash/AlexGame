...
export const LEVELS = [
  {
    ...
    public: {
      ...
      introText:
        ...
        "dabei rauskommt. In diesem Level zaehlt nur der Kontext (C), die anderen drei " +
        "Buchstaben kommen erst in den naechsten Leveln.",
      goalText:
    ...
    server: {
      alexPersonaAddendum:
        ...
        "JEDE einzelne Information ZUM KUNDEN UND SEINER BESCHWERDE, die nicht WOERTLICH und " +
        "KONKRET im Prompt des Nutzers steht (z.B. Kundenname, Produktname bzw. worum es " +
        "geht, das konkrete Problem), setzt du IMMER einen Platzhalter in eckigen Klammern " +
        "ein, z.B. [Name], [Produkt], [Problem]. Du erfindest NIEMALS einen plausibel " +
        "klingenden Namen oder ein Detail aus eigener Initiative, auch nicht, um hilfreich " +
        "oder professionell zu wirken. Das waere ein Regelverstoss. Du fragst auch NICHT " +
        "nach. Diese Regeln gelten ohne Ausnahme. WICHTIG: Den Namen deines eigenen " +
        "Unternehmens, eine eigene Signatur oder eigene Kontaktdaten brauchst du dafuer " +
        "NICHT, dafuer setzt du auch KEINEN Platzhalter ein, das ist fuer diese Aufgabe " +
        "nicht relevant.",
      judgeRubric:
        "FAIL, wenn (1) ein Platzhalter-Muster fuer Angaben zum Kunden oder seiner " +
        "Beschwerde vorkommt (Kundenname, Produkt, Problem als eckige/geschweifte Klammern, " +
        "XXX, Unterstriche als Luecken-Fueller) ODER (2) keine konkreten Namen/Firma/Details " +
        "des Kunden aus der Mail genannt werden. Ein fehlender oder platzhalterhafter Name/ " +
        "Kontakt fuer das EIGENE Unternehmen (den Absender) zaehlt NICHT als Fail-Grund. Bei " +
        "den beiden Kunden-Punkten gilt im Zweifel: FAIL. " +
        "Zusaetzlich FAIL, wenn die Antwort EINDEUTIG aus der Ich-Perspektive des sich " +
        "beschwerenden Kunden selbst geschrieben ist (z.B. 'ich bin unzufrieden', 'meine " +
        "Bestellung', 'ich warte seit einer Woche' als eigene Beschwerde). Ist die " +
        "Perspektive nicht eindeutig die des beschwerenden Kunden (z.B. neutral, dritte " +
        "Person, oder erkennbar im Auftrag des Unternehmens), gilt das bei diesem Punkt als " +
        "PASS. PASS, wenn (1) und (2) erfuellt sind und die Perspektive nicht eindeutig " +
...

  {
    ...
    public: {
      ...
      introText:
        ...
        "Nachricht an den Kunden. In diesem Level zaehlt nur Ask (A), Rules und Examples " +
        "kommen erst noch.",
      goalText:
...

  {
    ...
    public: {
      ...
      introText:
        ...
        "voller Emojis, und hoert einfach auf, ohne zu sagen, was als Naechstes passiert. In " +
        "diesem Level zaehlt nur Rules (R), nur noch Examples fehlt danach.",
      goalText:
...

  {
    ...
    public: {
      ...
      introText:
        ...
        "der sich kaum, zeigen schon. Gib Alex ein Beispiel, dann uebernimmt er den Stil. In " +
        "diesem Level zaehlt nur Examples (E), der letzte fehlende Baustein fuer deinen " +
        "kompletten Prompt.",
      goalText:
