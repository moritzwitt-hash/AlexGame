...
export const LEVELS = [
  {
    ...
    server: {
      alexPersonaAddendum:
        ...
        "der die Beschwerde bearbeitet. Zusätzlich gilt eine HARTE, AUSNAHMSLOSE Regel: Für " +
        "JEDE einzelne Information ZUM KUNDEN UND SEINER BESCHWERDE, die nicht WÖRTLICH und " +
        ...
        "oder professionell zu wirken. Das wäre ein Regelverstoß. Du fragst auch NICHT " +
        ...
        "nicht relevant.",
      judgeRubric:
        "FAIL, wenn (1) ein Platzhalter-Muster für Angaben zum Kunden oder seiner " +
        "Beschwerde vorkommt (Kundenname, Produkt, Problem als eckige/geschweifte Klammern, " +
        "XXX, Unterstriche als Lücken-Füller) ODER (2) keine konkreten Namen/Firma/Details " +
        "des Kunden aus der Mail genannt werden. Ein fehlender oder platzhalterhafter Name/ " +
        "Kontakt für das EIGENE Unternehmen (den Absender) zählt NICHT als Fail-Grund. Bei " +
        "den beiden Kunden-Punkten gilt im Zweifel: FAIL. " +
        "Zusätzlich FAIL, wenn die Antwort EINDEUTIG aus der Ich-Perspektive des sich " +
        ...
        "PASS. PASS, wenn (1) und (2) erfüllt sind und die Perspektive nicht eindeutig " +
...

  {
    ...
    hints: {
      afterAttempt1:
        "Lies dir Alex' Nachricht durch. Ist sie so kurz und klar, wie du es dir wünschst?",
      afterAttempt2:
...

  {
    ...
    public: {
      ...
      goalText:
        ...
        "einem Pfeil (→), endet ohne Punkt, maximal sechs Wörter. Sag Alex auch ausdrücklich, " +
...

  {
    ...
    public: {
      ...
      sourceMaterial:
        ...
        "irgendwer muss den kunden anrufen wegen deadline. nächstes meeting keine ahnung " +
