...
export const LEVELS = [
  {
    ...
    public: {
      ...
      introText:
        ...
        "er nicht. Schau dir erstmal an, was dabei rauskommt.",
      goalText:
        "Denk dir aus, was passiert ist: welcher Kunde, welches Produkt, worueber genau er " +
        "sich beschwert. Schreib das in deinen Prompt. Ohne diese Angaben kann Alex nur raten.",
      placeholderExample:
        "Sehr geehrte(r) [Name], vielen Dank fuer Ihre Nachricht bezueglich [Produkt]. Es " +
        "tut uns leid, dass [Problem] aufgetreten ist.",
    },
    server: {
      alexPersonaAddendum:
        "Dein Chef hat dir nur gesagt: 'Kuemmere dich um die Kundenbeschwerde.' Solange der " +
        "Prompt nichts anderes sagt, gehst du davon aus, dass du direkt dem Kunden antworten " +
        "sollst. Das ist eine HARTE, AUSNAHMSLOSE Regel: Fuer JEDE einzelne Information, die " +
        "nicht WOERTLICH und KONKRET im Prompt des Nutzers steht (z.B. Kundenname, " +
        "Produktname, das konkrete Problem), setzt du IMMER einen Platzhalter in eckigen " +
        "Klammern ein, z.B. [Name], [Produkt], [Problem]. Du erfindest NIEMALS einen " +
        "plausibel klingenden Namen oder ein Detail aus eigener Initiative, auch nicht, um " +
        "hilfreich oder professionell zu wirken. Das waere ein Regelverstoss. Du fragst auch " +
        "NICHT nach. Diese Regel gilt fuer JEDE fehlende Angabe ohne Ausnahme.",
      judgeRubric:
        ...
        "als Luecken-Fueller), UND (2) konkrete Namen/Produkte/Details sind vorhanden. FAIL, " +
        "wenn mindestens ein Platzhalter-Muster vorkommt ODER wenn unklar ist, ob eine Angabe " +
        "ein echter Wert oder ein verkappter Platzhalter ist (z.B. generische Fuellwoerter wie " +
        "'der Kunde', 'das Produkt' ohne echten Eigennamen). Im Zweifel: FAIL.",
      missingElementLabel: "context",
    },
    hints: {
      afterAttempt1:
        "Schau dir Alex' Antwort nochmal an. Was fehlt ihm, um wirklich zu wissen, worum es " +
        "geht, statt zu raten?",
      afterAttempt2:
        "Dir fehlt das C aus CARE: Context. Erzaehl Alex, was passiert ist: welcher Kunde, " +
        "welches Produkt, welches Problem.",
      afterAttempt4:
        "Probier sowas: 'Der Kunde heisst [Name], hat [Produkt] gekauft und beschwert sich, " +
        "weil [Problem].' Ersetz die Klammern durch echte Angaben.",
    },
  },
...

  {
    ...
    public: {
      ...
      goalText:
        "Du brauchst jetzt alle vier CARE-Buchstaben gleichzeitig in einem Prompt: gib " +
        "Kontext, sag klar was rauskommen soll (ein Protokoll, keine Zusammenfassung), gib " +
        "eine Struktur vor (zum Beispiel Themen, Entscheidungen, Aufgaben) und zeig bei " +
        "Bedarf, wie eine gute Zeile aussieht.",
      placeholderExample:
