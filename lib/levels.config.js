...
export const LEVELS = [
  {
    ...
    server: {
      ...
      judgeRubric:
        "FAIL, wenn (1) ein Platzhalter-Muster vorkommt (eckige/geschweifte Klammern, XXX, " +
        "Unterstriche als Luecken-Fueller) ODER (2) keine konkreten Namen/Firma/Details aus " +
        "der Mail genannt werden. Bei diesen beiden Punkten gilt im Zweifel: FAIL. " +
