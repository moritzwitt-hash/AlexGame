...
export const LEVELS = [
  {
    ...
    public: {
      ...
      goalText:
        ...
        "Unternehmens antwortet. Denk dir dann aus, was passiert ist: welcher Kunde, welches " +
        "Produkt, worueber genau er sich beschwert. Ohne diese Angaben kann Alex nur raten " +
        "oder schreibt aus der falschen Perspektive.",
      placeholderExample:
