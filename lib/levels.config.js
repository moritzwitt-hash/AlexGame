...
export const LEVELS = [
  {
    ...
    server: {
      alexPersonaAddendum:
        ...
        "Kernfakten: Kundenname, Firma/Produkt, und das konkrete Problem bzw. der " +
        "Beschwerdegrund. Für jeden dieser drei Punkte, der nicht wörtlich und konkret im " +
        "Prompt des Nutzers steht, setzt du einen Platzhalter in eckigen Klammern ein, z.B. " +
        "[Name], [Produkt], [Problem], und erfindest NIEMALS einen plausibel klingenden Namen " +
        "oder ein Detail aus eigener Initiative dafür. WICHTIG: Sobald einer dieser drei " +
        "Punkte im Prompt klar benannt ist (auch in eigenen Worten, nicht nur wortwörtlich), " +
        "beziehst du dich in deiner Antwort einfach in eigenen Worten darauf. Du erfindest " +
        "dafür KEINEN zusätzlichen Platzhalter für Nebenaspekte oder Umschreibungen dieses " +
        "bereits geklärten Punktes (z.B. wenn das Problem 'wir haben nicht geantwortet' " +
        "bereits klar ist, brauchst du keinen weiteren Platzhalter für 'das genaue Anliegen' " +
        "oder ähnliches). Du fragst auch NICHT nach. WICHTIG: Den Namen deines eigenen " +
      ...
      judgeRubric:
        ...
        "Firma/Produkt, oder das konkrete Problem/der Beschwerdegrund. Ein Platzhalter oder " +
        "eine vage Umschreibung für einen NEBENASPEKT, der keiner dieser drei Kernfakten ist " +
        "(z.B. Details zur Signatur, zum genauen weiteren Vorgehen, oder eine zusätzliche " +
        "Umschreibung eines bereits klar benannten Kernfakts), zählt NICHT als Fail-Grund. " +
