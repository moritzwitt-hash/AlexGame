...

  {
    ...
    public: {
      ...
      introText:
        ...
        "kompletten Prompt.",
      goalText:
        "Kopier die Zeilen unten in deinen Prompt, ersetz die Klammern durch etwas " +
        "Konkretes, und sag Alex, dass die GESAMTE Antwort nur aus solchen Zeilen bestehen " +
        "soll, ohne Einleitung oder Abschluss.\n\n" +
        "- [Aufgabe] übernehmen\n" +
        "- Rückmeldung bis [Datum] geben",
      placeholderExample:
